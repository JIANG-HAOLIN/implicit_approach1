...
#Slurm parameters
#SBATCH --job-name=o1_m_4
#SBATCH --output=o1_m_4_%j.%N.out
#SBATCH --ntasks=1
...
--model_supervision 2 --netG 3 --channels_G 64 --num_epochs 500 \
--checkpoints_dir ./checkpoints_multiscale_approach1_8_16_batch4_tanh_%j.%N --only_CLADE