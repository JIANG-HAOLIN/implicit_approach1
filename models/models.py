...
class OASIS_model(nn.Module):
    def __init__(self, opt):
        ...
        if opt.netG == 9:
            ...
            self.netG = generators.ImplicitGenerator_tanh_no_hypernetwork(opt=opt, size=(256, 512), hidden_size=512,
                                                          style_dim=512, n_mlp=8,
                                                          activation=None, channel_multiplier=2)
        elif opt.netG == 22:
            self.netG = generators.ImplicitGenerator_tanh_Fourier_dist(opt=opt, size=(256, 512), hidden_size=512,
                                                          style_dim=512, n_mlp=8,
                                                          activation=None, channel_multiplier=2)
        elif opt.netG == 3:
